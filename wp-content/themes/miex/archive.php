...
get_header(); ?>
             ...
             <h2><?php
                        if ( is_day() ) :
                            printf( esc_html__( 'Daily Archives: %s', 'miex' ), get_the_date() );

                        elseif ( is_month() ) :
                            printf( esc_html__( 'Monthly Archives: %s', 'miex' ), get_the_date( _x( 'F Y', 'monthly archives date format', 'miex' ) ) );

                        elseif ( is_year() ) :
                            printf( esc_html__( 'Yearly Archives: %s', 'miex' ), get_the_date( _x( 'Y', 'yearly archives date format', 'miex' ) ) );

                        else :
                            echo esc_html__( 'Archives', 'miex' );
